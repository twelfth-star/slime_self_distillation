...
def create_training_models(args, pgs, rollout_manager):
    ...
    require_ref_model = args.kl_coef != 0 or args.use_kl_loss
    if (
        args.train_backend == "fsdp"
        and args.loss_type == "custom_loss"
        and (
            getattr(args, "self_distill_kl_scope", "off") == "full_vocab"
            or (
                getattr(args, "self_distill_kl_scope", "off") == "sampled_token"
