...
def process_rollout_data(args, rollout_data_ref, dp_rank, dp_size):
    ...
    if "teacher_total_lengths" in rollout_data:
        teacher_total_lengths = rollout_data["teacher_total_lengths"]
        rollout_data["teacher_total_lengths"] = [teacher_total_lengths[i] for i in partition]
